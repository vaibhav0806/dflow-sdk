...
<Cards>
  <Card title="Getting Started" href="/docs/typescript/getting-started/installation">
    Install the SDK and make your first API call
  </Card>
  <Card title="Client Configuration" href="/docs/typescript/api-reference/client">
    Configure the DFlowClient with API keys and custom endpoints
  </Card>
  <Card title="Prediction Markets" href="/docs/typescript/api-reference/events">
    Work with events, markets, orderbooks, and trades
  </Card>
  <Card title="Trading" href="/docs/typescript/api-reference/swap">
