...
The DFlow TypeScript SDK documentation is available in a machine-readable format optimized for Large Language Models (LLMs) and AI assistants.
...
```
https://dflow-sdk.vercel.app/docs/typescript/llms.txt
```

You can also access it locally when running the docs:

```
http://localhost:3000/docs/typescript/llms.txt
```
...
3. Add `https://dflow-sdk.vercel.app/docs/typescript/llms.txt` as a documentation source
...
```
Please read the DFlow TypeScript SDK documentation from:
https://dflow-sdk.vercel.app/docs/typescript/llms.txt
...
```typescript
const response = await fetch('https://dflow-sdk.vercel.app/docs/typescript/llms.txt');
...
- [DFlow TypeScript SDK Documentation](/docs/typescript)
- [API Reference](/docs/typescript/api-reference/client)
